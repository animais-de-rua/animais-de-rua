...
CREATE TABLE `article_related` (
  ...
  KEY `article_related_related_id_foreign` (`related_id`),
  CONSTRAINT `article_related_article_id_foreign` FOREIGN KEY (`article_id`) REFERENCES `articles` (`id`),
  CONSTRAINT `article_related_related_id_foreign` FOREIGN KEY (`related_id`) REFERENCES `articles` (`id`) ON DELETE CASCADE
...
CREATE TABLE `articles` (
  ...
  `slug` varchar(127) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `images` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `videos` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `status` enum('publish','draft') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date` date NOT NULL,
  ...
  `extras_translatable` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `pages` (
  ...
  `extras_translatable` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (3,'2015_08_04_130518_create_tags_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (4,'2015_08_04_130519_create_categories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2015_08_04_130520_create_articles_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2015_08_04_131614_create_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2015_09_07_190535_create_languages_table',1);
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (10,'2019_10_17_141133_create_permission_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (11,'2019_10_31_114936_add_user_fields',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (12,'2019_12_14_000001_create_personal_access_tokens_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (14,'2024_04_02_165233_create_language_lines_table',2);
