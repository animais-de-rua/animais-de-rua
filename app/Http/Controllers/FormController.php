...
{
    public function form_view(string $slug): RedirectResponse
    {
    ...
    public function form_submit(string $slug): ?JsonResponse
    {
        return match ($slug) {
            'volunteer' => $this->form_submit_volunteer(),
            'contact' => $this->form_submit_contact(),
            'apply' => $this->form_submit_apply(),
            'training' => $this->form_submit_training(),
            'godfather' => $this->form_submit_godfather(),
            'petsitting' => $this->form_submit_petsitting(),
            default => null,
        };
    }

    public function form_submit_volunteer(): JsonResponse
    {
    ...
    public function form_submit_contact(): JsonResponse
    {
        $validatedData = request()->validate([
            'name' => 'required',
            'email' => 'required|email',
    ...
    public function form_submit_apply(): JsonResponse
    {
        $request = request();
    ...
    public function form_submit_training(): JsonResponse
    {
        $validatedData = request()->validate([
            'name' => 'required',
            'email' => 'required|email',
    ...
    public function form_submit_godfather(): JsonResponse
    {
        $validatedData = request()->validate([
            'name' => 'required',
            'email' => 'required|email',
    ...
    public function form_submit_petsitting(): JsonResponse
    {
        $request = request();
    ...
    private function subscribe_newsletter(): void
    {
